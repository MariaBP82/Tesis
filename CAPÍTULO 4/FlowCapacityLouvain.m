...
A = readmatrix('A.csv');  % Matriz de adyacencia A^D
I = readmatrix('I.csv');  % Matriz de adyacencia I^D
...
% Llamar a la función
[COMTY, ending] = compute_FlowCapacityLouvain(A, I, alpha, s, self, debug, verbose);
